...
namespace strange.extensions.injector.impl
{
  public class Injector : IInjector
  {
    ...
    private void performSetterInjection (object target, IReflectedClass reflection)
    {
      ...
      failIf (reflection.Setters.Length != reflection.SetterNames.Length,
    ...
    private void armorAgainstInfiniteLoops (IInjectionBinding binding)
    {
      ...
      {
        throw new InjectionException ("There appears to be a circular dependency. Terminating loop.",
